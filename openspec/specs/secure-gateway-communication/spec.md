...
KrakenD, and the Spring Boot backend. This spec preserves the GSD-validated
requirements that OAuth2 gates protected access and mobile traffic reaches the
